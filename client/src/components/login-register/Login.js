...
class Login extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            img src = "https://images.unsplash.com/photo-1516478177764-9fe5bd7e9717?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80"
            alt = "user icon" /
            >
            <
            /div> <
            ...
            Form > {
                errorsForm.isRequired !== null ? ( <
                    Alert color = "danger"
                    className = "" > { errorsForm.isRequired } <
                    /Alert>
                ) : null
            } <
            FormGroup >
            ...
            > {
                errors.errPassword ? ( <
                    Alert color = "danger"
                    className = "mt-3" > { errors.errPassword } <
                    /Alert>
                ) : null
            } <
            /FormGroup> <
